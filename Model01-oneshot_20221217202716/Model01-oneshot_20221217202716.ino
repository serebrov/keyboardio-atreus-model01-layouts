...
KALEIDOSCOPE_INIT_PLUGINS(
  ...
  // Enable OneShot and EscapeOneShot
  // ..Config plugins are to make them configurable in Chrysalis.
  // See
  // - https://github.com/serebrov/Kaleidoscope/blob/master/examples/Devices/Keyboardio/Atreus/Atreus.ino
  // - https://kaleidoscope.readthedocs.io/en/latest/plugins/Kaleidoscope-Escape-OneShot.html
  // - https://kaleidoscope.readthedocs.io/en/latest/plugins/Kaleidoscope-OneShot.html
  OneShot,
  EscapeOneShot,
  // Configuration in Chrysalis works without OneShotConfig and compilation
  // error is rasied if I include it.
  // OneShotConfig,
  EscapeOneShotConfig,
  ...
  Macros,
  // Disabled as there is not enough space.
  //DynamicMacros,
